...
class Ui_DetectionZoom(object):
    def setupUi(self, DetectionZoom):
        ...
        self.detectionSpinBox.setEnabled(True)
        self.detectionSpinBox.setGeometry(QtCore.QRect(250, 450, 111, 22))
        self.detectionSpinBox.setWrapping(False)
        self.detectionSpinBox.setFrame(False)
        self.detectionSpinBox.setReadOnly(False)
        self.detectionSpinBox.setCorrectionMode(QtWidgets.QAbstractSpinBox.CorrectToPreviousValue)
        self.detectionSpinBox.setKeyboardTracking(False)
        self.detectionSpinBox.setProperty("showGroupSeparator", False)
        self.detectionSpinBox.setObjectName("detectionSpinBox")
        self.label = QtWidgets.QLabel(self.graphWidget)
        self.label.setGeometry(QtCore.QRect(170, 450, 71, 20))
        font = QtGui.QFont()
